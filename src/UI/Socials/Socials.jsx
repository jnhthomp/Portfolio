...
const Socials = (props) => {
  ...
  return (
    <section className={classList}>
      {/* <!-- LinkedIn --> */}
      <a className="interactable" data-type="link"  href="https://www.linkedin.com/in/jonah-thompson-91b74821a/">
      ...
      {/* <!-- Github --> */}
      <a className="interactable" data-type="link" href="https://github.com/jnhthomp">
        <svg height="100%" viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
      ...
      {/* <!-- Email --> */}
      <a className="interactable" data-type="link" href="mailto:jnh.thompson@gmail.com?subject=Feedback&body=Message">
        <svg height="100%" viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
